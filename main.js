...
const canciones = [
  "[XG TAPE _2]  (COCONA).mp3",
  "BLACKPINK - _Shut Down.mp3",
  "BTS - DDAENG _Namjoon.mp3",
  "Hoseok _More.mp3",
  "Jimin VIBE.mp3",
  "Jin - The Astronaut.mp3",
  "JUNGKOOK - DREAMERS (FIFA WORLD CUP QATAR).mp3",
  "Mad Clown_ Kim Na Young.mp3",
  "RM- Wild flower.mp3",
  "Run BTS.mp3",
  "V  nuga.mp3",
  "Whalien 52.mp3",
